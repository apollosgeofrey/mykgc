        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-4 text-right">
                    <a href="invoice_history.php" class="btn btn-sm btn-primary">Back to list</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                            ...
                            <?php
                                    if (isset($_GET['db_db_id']) && isset($_GET['tx_refer'])) {
                                        ...
                                        if (!empty($db_db_id) && !empty($tx_refer)) {
                                            if (isset($conn)) {
                                                $query_hist = $conn->prepare("SELECT * FROM `kokozum_payment_records` WHERE db_id='$db_db_id' AND tx_ref='$tx_refer' AND payment_status='0'");
                                                $query_hist->execute();
                                                ...
                                                if ($query_hist_run == true && mysqli_num_rows($query_hist_run) === 1) {
                                                    while ($rows = mysqli_fetch_assoc($query_hist_run)) {
                                                        ...
                                                        if($db_payment_status == '0'){
                                                            ...
                                                            die('This transaction was Successful');
                                                        }
